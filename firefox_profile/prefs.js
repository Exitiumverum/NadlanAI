...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1745609835);
user_pref("app.update.lastUpdateTime.background-update-timer", 1745609835);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1745609835);
user_pref("app.update.lastUpdateTime.region-update-timer", 1745609835);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1745609835);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1745609835);
...
user_pref("browser.contextual-services.contextId", "{cdae5521-356d-46f1-a701-672a8eedceb6}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{e42b27ae-5e48-4292-b157-640fb00181c6}");
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20250208003706");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1745610856);
...
user_pref("captchadetection.lastSubmission", 1745609);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECC5wmF4Au0xmBAjQ9BXpdg4Hjg==");
user_pref("extensions.formautofill.creditCards.supported", "off");
user_pref("extensions.getAddons.cache.enabled", false);
user_pref("extensions.installDistroAddons", false);
user_pref("extensions.lastAppBuildId", "20250208003706");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"af211c5b-b08b-4ec8-80d0-11fcf682fdea\",\"pictureinpicture@mozilla.org\":\"7e1a62f3-7742-487b-b4bb-9c05258fa357\",\"screenshots@mozilla.org\":\"815b9759-e8c5-4325-8268-ad6a047c8e70\",\"webcompat-reporter@mozilla.org\":\"3da1c3ec-8090-4a3b-a3c6-837911265c24\",\"webcompat@mozilla.org\":\"90610bed-04de-4511-b3ab-e5001d6571ce\",\"default-theme@mozilla.org\":\"25d39714-12c6-40f0-8948-496cda736f19\",\"addons-search-detection@mozilla.com\":\"9a8e4389-0577-4180-863c-086d9e3bc2ee\"}");
...
user_pref("media.gmp-manager.buildID", "20250208003706");
user_pref("media.gmp-manager.lastCheck", 1745610818);
user_pref("media.gmp-manager.lastEmptyCheck", 1745610818);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECF4K2SUJOb8aBAhLKq36zECr+g==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1745610854);
...
user_pref("toolkit.telemetry.previousBuildID", "20250208003706");
